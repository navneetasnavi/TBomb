#!/bin/bash
clear
echo -e "\e[4;31m NaVi Productions !!! \e[0m"
...
echo This Script Was Made By NaVi >update.speedx
...
clear
echo -e "\e[1;32m"
echo 'Call Bomb By NaVi'> call.xxx
